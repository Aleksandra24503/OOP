...
//A.set_yearOfProduction(c); //ERROR
ca->set_yearOfProduction(c);

system("cls");
cout<<"Year of production - "<<ca->get_yearOfProduction()<<endl;
cout<<"Age of vehicle - "<<ca->ageOfVehicle()<<endl;

//cout<<"Year production - " <<A.get_yearOfProduction()<<endl; // ERROR
//cout<<"Age of vehicle - "<<A.ageOfVehicle()<<endl; //ERROR
